...
function singleBook () {
    ...
    return (
        ...
        <div className="col-1 rounded-xl items-center justify-evenly text-center">
            ...
            <img className="mx-auto py-12 min-h-36 min-w-36 content-center items-center justify-center" src={`https://backend-codehelper-trial.onrender.com/uploads/${data?.thumbnail}`}
            alt={data?.title} />
